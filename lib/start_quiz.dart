...
class StartQuiz extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(theme:ThemeData(colorSchemeSeed: Colors.black),home: const StartQuizScreen());
  }
}
...
class _StartQuizState extends State<StartQuizScreen> {
  ...
  String info = 'For years it was believed that Earth was the only planet in our solar system with liquid water. More recently, NASA revealed its strongest evidence yet that there is intermittent running water on Mars, too!';//To be replaced by database query
  @override
  Widget build(BuildContext context) {
    return Scaffold(
